...
/**
  * @brief  Communicate with the Brake Infrared (IR) sensor and acquire raw voltage 
  * data from the sensor. Then convert the raw voltage data to voltage and temperature
  * data and print it to the serial monitor.
